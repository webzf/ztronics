...
<div id="quick-start" class="quick-start"><div class="quick-start-heading"><strong>Quick start</strong><span>Start with a common profile or customize the filters below.</span></div><div class="preset-grid"><a class="preset-button" href="?family=ESP32-S3&amp;family_req=1&amp;psram_min=8&amp;psram_min_req=1#results">ESP32-S3 + PSRAM 8 MB</a><a class="preset-button" href="?display_present=yes&amp;display_present_req=1&amp;touch=yes&amp;touch_req=1&amp;touch_interface=SPI&amp;touch_interface_req=1#results">Touchscreen + SPI</a><a class="preset-button" href="?native_usb=yes&amp;native_usb_req=1#results">Native USB</a><a class="preset-button" href="?display_present=yes&amp;display_present_req=1&amp;size_min=4&amp;size_min_req=1#results">Large display</a></div></div>
...
<script src="/assets/tools/esp32-touchscreen-selector/compatibility-engine.js?v=20260920-4" defer></script>
<script src="/assets/tools/esp32-touchscreen-selector/selector.js?v=20260920-4" defer></script>
