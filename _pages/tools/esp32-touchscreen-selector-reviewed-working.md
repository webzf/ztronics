...
<div id="quick-start" class="quick-start"><div class="quick-start-heading"><strong>Quick start</strong><span>Start with a common profile or customize the filters below.</span></div><div class="preset-grid"><a class="preset-link" href="#preset=s3-psram" data-preset="s3-psram" onclick="if(window.EmbeddedNerdApplyPreset){window.EmbeddedNerdApplyPreset('s3-psram');return false;}">ESP32-S3 + PSRAM 8 MB</a><a class="preset-link" href="#preset=touch-spi" data-preset="touch-spi" onclick="if(window.EmbeddedNerdApplyPreset){window.EmbeddedNerdApplyPreset('touch-spi');return false;}">Touchscreen + SPI</a><a class="preset-link" href="#preset=native-usb" data-preset="native-usb" onclick="if(window.EmbeddedNerdApplyPreset){window.EmbeddedNerdApplyPreset('native-usb');return false;}">Native USB</a><a class="preset-link" href="#preset=large-display" data-preset="large-display" onclick="if(window.EmbeddedNerdApplyPreset){window.EmbeddedNerdApplyPreset('large-display');return false;}">Large display</a></div></div>
