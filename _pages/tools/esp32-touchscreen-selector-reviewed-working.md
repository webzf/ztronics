...
<div id="quick-start" class="quick-start"><div class="quick-start-heading"><strong>Quick start</strong><span>Start with a common profile or customize the filters below.</span></div><div class="preset-grid"><a class="preset-link" href="#preset=s3-psram">ESP32-S3 + PSRAM 8 MB</a><a class="preset-link" href="#preset=touch-spi">Touchscreen + SPI</a><a class="preset-link" href="#preset=native-usb">Native USB</a><a class="preset-link" href="#preset=large-display">Large display</a></div></div>
