...
Both sensors work well with the [ESP32 DevKit V1](/products/esp32-devkit/), making it possible to use the same development board for either project.
...
If you need a modern 6-axis IMU with both an accelerometer and gyroscope, the ICM-42670-P is one of the alternatives worth considering. See our detailed guide to the [ICM-42670-P as an MPU6050 replacement](/mpu6050-discontinued-alternatives/#icm-42670-p).
