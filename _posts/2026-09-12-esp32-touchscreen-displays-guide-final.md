...
![ESP32 resistive vs capacitive touchscreen comparison](/assets/images/esp32-resistive-vs-capacitive-touchscreen.webp)
...
![ESP32 touchscreen SPI vs RGB display interface comparison](/assets/images/esp32-spi-vs-rgb-display-interface.webp)
...
Controllers such as the **ILI9341** and **[ST7789](/products/st7789-tft/)** are widely used in ESP32 and Arduino projects.
...
![2.8 inch 4.3 inch and 7 inch ESP32 touchscreen size comparison](/assets/images/esp32-touchscreen-size-comparison.webp)
...
![ESP32-S3 4.3 inch and 7 inch touchscreen display comparison](/assets/images/esp32-s3-touch-lcd-4-3-vs-7.webp)
...
![ILI9341 XPT2046 touchscreen connected to an ESP32](/assets/images/ili9341-xpt2046-esp32-touchscreen-setup.webp)
...
![LVGL graphical user interface on an ESP32 touchscreen](/assets/images/esp32-touchscreen-lvgl-gui.webp)
