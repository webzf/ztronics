...
alt: "ESP32 DevKit V1 development board with Wi-Fi and Bluetooth"
...
excerpt: "ESP32 DevKit V1 development board with Wi-Fi and Bluetooth. Check specifications, compatibility and current prices for Arduino and IoT projects."

description: "ESP32 DevKit V1 development board based on the ESP32 dual-core Xtensa LX6 microcontroller, with integrated Wi-Fi and Bluetooth for Arduino, IoT and embedded projects."
...
links:
  ...
  - title: Datasheet
    ...
    description: Espressif ESP32 Datasheet
...
If you're connecting multiple I2C devices such as an OLED display and an MPU6050, our **[I2C Scanner Tutorial](/i2c-scanner-tutorial/)** explains how to identify devices connected to the I2C bus.
...
You can also browse our **[Products](/products/)** section for compatible hardware or explore our **[Recommended Hardware](/recommended-hardware/)** collection for components commonly used with the ESP32.
