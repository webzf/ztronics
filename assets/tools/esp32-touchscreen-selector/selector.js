...
function setupPresets(){var buttons=document.querySelectorAll(".preset-button");buttons.forEach(function(b){b.addEventListener("click",function(e){e.preventDefault();applyPreset(b.dataset.preset);});});}
