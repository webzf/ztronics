...
function setupPresets(){window.EmbeddedNerdApplyPreset=applyPreset;document.addEventListener("click",function(e){var b=e.target&&e.target.closest?e.target.closest(".preset-button"):null;if(!b)return;e.preventDefault();applyPreset(b.dataset.preset);});}
